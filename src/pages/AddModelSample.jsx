              ...
              <div className="flex flex-col items-center p-4">
                ...
                >
                  <div className="flex flex-col flex-wrap gap-5 justify-center items-start w-full sm:flex-row">
                    ...
                    {formData?.type === "sampling" && <div className="sm:w-[400px] min-h-[60px] w-full">
                      <div className="form-control">
                        <InputLabel
                          className="w-full label"
                          id="demo-simple-select-label"
                    ...
                    {formData?.type === "incident" && <div className="sm:w-[400px] min-h-[60px] w-full">
                      <div className="form-control">
                        <InputLabel
                          className="w-full label"
                    ...
                    {formData?.type === "sampling" && <div className="sm:w-[400px] min-h-[60px] w-full">
                      <div className="form-control">
                        ...
                        <Select
                          ...
                          onChange={handleInputChange}
                          autoWidth
                          required={formData?.type === "sampling"}
                          name="presence"
                    ...
                    {["sampling", "incident"].includes(formData.type) && <div className="sm:w-[400px] min-h-[60px] w-full">
                      <FormInput
                        onChange={handleInputChange}
